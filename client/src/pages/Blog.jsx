...
const Blog = () => {
  ...
  return (
    <section>
          <Header/>
                  <div className='w-full bg-[#FCFCFC] h-[100px] mb-[20px] flex items-center font-poppins'>
                  ...
                  <div className='w-full  py-[20px] flex justify-center font-fredoka items-start  flex-col px-[20px] md:px-[150px]'>
                                  <ul className='flex justify-start items-center gap-[10px]'>
                                      ...
                                      <li className='text-[14px] md:text-[16px]'>Blogs</li>
                                  </ul>
                              </div>
                  </div>
            ...
            {blogs.slice(0,8).map((data) => (
              <div className="group" key={data.id}>
                <div className="overflow-hidden rounded-[5px] cursor-pointer">
                  <NavLink>
                    <img
                      className="group-hover:scale-[1.1] h-[300px] w-full group-hover:rotate-[3deg] transition-all duration-500 rounded-[5px]"
                      src={data?.image}
                      alt=""
                    />
                  </NavLink>
