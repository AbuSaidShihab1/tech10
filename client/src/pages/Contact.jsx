  ...
  const handleform=(e)=>{
    e.preventDefault();
      if(!name=="" || !email=="" || !subject=="" || !phone=="" || !message==""){
           axios.post(`${backend_link}/contact`,{name,email,subject,phone,message})
           .then((res)=>{
            if(res){
              toast.success("Your contact information has been submited!")
            }e
           }).catch((err)=>{
            console.log(err)
           })
...
/>
        ...
        <div className='w-full  py-[20px] flex justify-center font-fredoka items-start  flex-col px-[20px] md:px-[150px]'>
                ...
                <section className='md:px-[150px] px-[20px] py-[30px] md:py-[50px] '>
                   <section className='flex justify-between items-center gap-[30px]'>
                    <div className='w-[30%] flex gap-[20px] justify-center items-center'>
                      <div>
                        <img src="https://shofy-nuxt.vercel.app/img/contact/contact-icon-2.png" alt="" />
                      </div>
                      <div>
                        <h1 className='text-[20px] font-[500] mt-[10px] font-fredoka'>United Kingdom</h1>
                        <p className='font-poppins text-[15px] font-[500] text-neutral-700 mt-[5px]'>6391 Elgin St. Celina, Delaware 10299</p>
                        <p className='text-neutral-500 font-poppins text-[15px] mt-[5px]'>(808) 555-0111</p>
                      </div>
                    </div>
                    <div className='w-[30%] flex gap-[20px] justify-center items-center'>
                      <div>
                        <img src="https://shofy-grocery-next-js.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcontact-icon-1.9066600e.png&w=64&q=75" alt="" />
                      </div>
                      <div>
                        <h1 className='text-[20px] font-[500] mt-[10px] font-fredoka'>United Kingdom</h1>
                        <p className='font-poppins text-[15px] font-[500] text-neutral-700 mt-[5px]'>6391 Elgin St. Celina, Delaware 10299</p>
                    ...
                    <div className='w-[30%] flex gap-[20px] justify-center items-center'>
                      <div>
                        <img src="https://shofy-grocery-next-js.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcontact-icon-3.a1ff7720.png&w=96&q=75" alt="" />
                      </div>
                      <div>
                        <h1 className='text-[20px] font-[500] mt-[10px] font-fredoka'>United Kingdom</h1>
                        <p className='font-poppins text-[15px] font-[500] text-neutral-700 mt-[5px]'>6391 Elgin St. Celina, Delaware 10299</p>
                   ...
                   <section className='border-[1px] border-[#e7e9eb] w-full h-auto p-[50px] flex justify-between  gap-[30px] mt-[70px]'>
                    <div className='w-[40%]'>
                    ...
                    {/* -------------------form -------------------- */}
                      <form className='w-[55%] font-poppins'onSubmit={handleform}>
                        <div>
